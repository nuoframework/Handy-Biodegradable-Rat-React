        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <fragment>
                  <span className="pricing14-text064 thq-heading-2">
                    Pricing plan
                  </span>
                </fragment>
              )}
            ...
            <p>
              {props.content2 ?? (
                <fragment>
                  <span className="pricing14-text055 thq-body-large">
                    <span>
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <fragment>
                        <span className="pricing14-text091 thq-heading-3">
                          Starting at €100
                        </span>
                      </fragment>
                    )}
                  ...
                  <p>
                    {props.plan1Yearly ?? (
                      <fragment>
                        <span className="pricing14-text100 thq-body-large">
                          €1000/year
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price06">
                <div className="pricing14-price07">
                  ...
                  <h3>
                    {props.plan1Price1 ?? (
                      <fragment>
                        <span className="pricing14-text070 thq-heading-3">
                          $200/yr
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price08">
                <div className="pricing14-price09">
                  <span>
                    {props.plan21 ?? (
                      <fragment>
                        <span className="pricing14-text060 thq-body-large">
                          Business plan
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <fragment>
                        <span className="pricing14-text089 thq-heading-3">
                          $499/yr
                        </span>
                      </fragment>
                    )}
                  ...
                  <span>
                    {props.plan3Yearly1 ?? (
                      <fragment>
                        <span className="pricing14-text092 thq-body-large">
                          or $49 monthly
                        </span>
                      </fragment>
                    )}
